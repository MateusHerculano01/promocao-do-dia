...
import { EditAnnouncedProduct } from "@screens/AdvertiserGroup/EditAnnouncedProduct";
...
export function AdvertiserRoutes() {
  ...
  return (
    <AdvertiserStack.Navigator screenOptions={{ headerShown: false }} initialRouteName="AdvertiserDashboard">
      ...
      <AdvertiserStack.Screen name="EditAnnouncedProduct" component={EditAnnouncedProduct} />
